...
const EditCategoryFrom = ({ editCategoryModal, setEditCategoryModal }) => {
  ...
  const getCategory = ()=>{
    ...
    const category = menu?.categories.find(ctg=>ctg._id === editCategoryModal)
    if(!category) return null
    setRid(category._id)
    setValue("name", category.name)
    setValue("description", category.description)
    setValue("_date", category._date)
    setValue("date_", category.date_)
    setValue("deliveryMethod", category.deliveryMethod)
    setValue("dayWeek", category.dayWeek)
          ...
          <div className="pb-4 ">
            ...
            <div className="flex justify-around items-center gap-2 mt-3">
              ...
              <div>
                ...
                <input
                  type="date"
                  className={`input w-full border-2  h-[36.77px] w-[160px]p-3   ${
          ...
          <div className="pb-5 ">
            ...
            <div className="flex justify-around items-center gap-2 mt-3 pb-10">
              <div className="">
                ...
                <select
                  className={`input w-full border-2 h-[40.85px] text-xs  ${
