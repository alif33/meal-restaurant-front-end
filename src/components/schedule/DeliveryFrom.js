...
const DeliveryFrom = ({ setDeliveryForm, deliveryForm }) => {
    ...
    <>
      ...
      <div className="fixed top-0 right-0 w-[30%] h-screen bg-[#fff] py-8 px-7  overflow-y-auto  ">
        <div className="flex items-center justify-between mb-4 pb-4 border-b border-solid border-[#D7D7D7]   ">
          <h4 className=" text-[#757575] text-[13px] ">Edit Delivery Hours</h4>
          <button
            onClick={() => setDeliveryForm(!deliveryForm)}
        ...
        <h4 className=" text-lg text-[#212121] ">Delivery Hours</h4>
        <ul>
